$(document).ready(function() {
    ...
    // Start brandEditFormValidation
    //   $('.brandEditValidation').submit(function(e) {
    //     // alert('edit')
    //     e.preventDefault();
    //     var name = $('#editname').val();
    //     alert(name);
    //     var _token = $('input[name="_token"]').val();
    //     var brandName = document.forms["brandEditForm"]["editname"].value;
    //     alert(brandName);
    //     var letters = /[0-9a-zA-Z]+$/;
    //     if (brandName == '') {
    //     document.getElementById('editname').classList.add('is-invalid')
    //     document.getElementById('editnameMessage').innerHTML = " Brand Name is Mendotary"
    //     return false;
    //     } else if (brandName.length >= 50) {
    //     document.getElementById('editname').classList.add('is-invalid')
    //     document.getElementById('editnameMessage').innerHTML = " Brand Name Maximum length is 50"
    //     return false;
    //     } else if (!brandName.match(letters)) {
    //     document.getElementById('editname').classList.add('is-invalid')
    //     document.getElementById('editnameMessage').innerHTML = "  Brand name can only allow alphanumeric characters"
    //     return false;
    //     }
    ...
    //                     document.getElementById('editname').classList.add('is-invalid')
    //                     document.getElementById('editnameMessage').innerHTML = " Duplicate brand name will not be allowed"
    //                     return false;
    //                 }
    //                 else
    //                 {
